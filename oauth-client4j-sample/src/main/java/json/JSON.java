...
import json.serializer.SerializeFilter;
...
import json.util.IOUtils;
import json.util.ThreadLocalCache;
...
public abstract class JSON implements JSONStreamAware, JSONAware {
    ...
    static {
        int features = 0;
        features |= json.serializer.SerializerFeature.QuoteFieldNames.getMask();
        features |= json.serializer.SerializerFeature.SkipTransientField.getMask();
        features |= json.serializer.SerializerFeature.WriteEnumUsingToString.getMask();
        features |= json.serializer.SerializerFeature.SortField.getMask();
        // features |=
        // com.kingdee.json.serializer.SerializerFeature.WriteSlashAsSpecial.getMask();
    ...
    public static final String toJSONString(Object object, SerializerFeature... features) {
        ...
        try {
            ...
            for (json.serializer.SerializerFeature feature : features) {
